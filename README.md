...
These files are tracked so that the figures, tables and results page can be rebuilt without refitting the models. The fitted models are too large to track in GitHub and can be regenerated by running `3_analysis/3_models.R`.
